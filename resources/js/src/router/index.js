...
const create = () => import('../views/Reparation/create.vue')
const reparationList = () => import('../views/Reparation/list.vue')
const reparationShow = () => import('../views/Reparation/show.vue')
const filters = () => import('../views/Reparation/filters.vue')
...
const formChildRoute = (prop) => [
  ...
  {
    path: '/reparation/filters',
    name: 'reparation.filters',
    component: filters,
    meta: { auth: true, name: 'Reparation filters' },
  },
  {
    path: 'form-validate',
    name: prop + '.validate',
