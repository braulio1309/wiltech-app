...
import LayoutFixRightSide from '../layouts/Components/LayoutFixRightSide.vue'
export default {
  name: 'Layout1',
  components: {
    Loader,
  ...
  mounted () {
    document.body.classList = 'sidebar-main-active right-column-fixed header-top-bgcolor'
  },
  destroyed () {
